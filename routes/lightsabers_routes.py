...
def get_lightsaber_by_id_route(owner_id):
    return controllers.get_lightsaber_by_id(owner_id)


@lightsaber.route('/lightsaber/<saber_id>', methods=['PUT'])
def update_lightsaber_by_id_route(saber_id):
    return controllers.update_lightsaber_by_id(saber_id)


@lightsaber.route('/lightsaber/delete/<saber_id>', methods=['DELETE'])
def delete_lightsaber_by_id_route(saber_id):
